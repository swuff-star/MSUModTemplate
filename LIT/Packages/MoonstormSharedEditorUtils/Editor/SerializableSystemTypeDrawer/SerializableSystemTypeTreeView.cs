...
namespace Moonstorm.EditorUtils.TreeDrawers
{
    ...
    public class SerializableSystemTypeTreeView : TreeListControl
    {
        ...
        public void PopulateItem(Type type)
        {
            ...
            var systemType = attachPoint.AddItem(type.Name, true, false, new SystemTypeTreeInfo(type));
            AddHandlerEvents(systemType);
        }
        ...
        private void PrepareDragDrop(object sender, System.EventArgs args)
        {
            ...
            try
            {
                ...
                if (treeInfo.itemType != ItemType.SystemType)
                    return;
        ...
        public override void AssignDefaults()
        {
            ...
            textureSystemTypeIcon = GetTexture(stateDrawerPath + "entity_state.png");
        ...
        public Texture2D textureSystemTypeIcon;
        ...
        public void CustomIconHandler(object sender, System.EventArgs args)
        {
            ...
            if (ItemType.SystemType == treeInfo.itemType)
                ShowButtonTextureInternal(textureSystemTypeIcon);
            else
        ...
        public class SystemTypeTreeInfo
        {
            ...
            public SystemTypeTreeInfo(Type systemType)
            {
                shortHandName = systemType.Name;
                fullName = systemType.AssemblyQualifiedName;
                itemType = ItemType.SystemType;
            }
